...
public final class WebSocketServer {
    ...
    public void start() throws Exception {
        ...
        WebSocketConfig config = (WebSocketConfig)ac.getBean("webSocketConfig");

        EventLoopGroup bossGroup = new NioEventLoopGroup(config.bossCount);
        EventLoopGroup workerGroup = new NioEventLoopGroup(config.workerCount);
        try {
